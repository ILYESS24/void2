...
# Installer explicitement les packages gulp requis par gulpfile.reh.js, gulpfile.scan.js et build/lib/asar.js
echo ""
echo "📦 Installation explicite des packages gulp requis par gulpfile.reh.js, gulpfile.scan.js et build/lib/asar.js..."
npm install gulp-replace@0.5.4 gulp-untar@0.0.7 gulp-gunzip@1.0.0 gulp-flatmap@1.0.2 gulp-json-editor@2.5.0 @vscode/gulp-electron@^1.36.0 chromium-pickle-js@^0.2.0 asar@^3.0.3 --legacy-peer-deps --save-prod --force --ignore-scripts 2>&1 | tail -10 || echo "⚠️ Installation des packages gulp-reh échouée"

# Vérifier que les packages sont bien installés
echo "🔍 Vérification des packages gulp-reh, gulp-scan et asar..."
for pkg in gulp-replace gulp-untar gulp-gunzip gulp-flatmap gulp-json-editor chromium-pickle-js asar; do
