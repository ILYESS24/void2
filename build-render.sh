...
echo "Installation de gulp, typescript, @vscode/test-web, rimraf, event-stream, gulp-rename, glob, vinyl, vinyl-fs, fancy-log, ansi-colors, through2, pump, debounce..."
npm install gulp@4.0.0 typescript @vscode/test-web rimraf event-stream gulp-rename@1.2.0 glob@5.0.13 vinyl@2.2.1 vinyl-fs@2.4.4 fancy-log@1.3.3 ansi-colors@3.2.3 through2@4.0.2 pump@3.0.3 debounce@1.2.1 --legacy-peer-deps --save-prod --force --ignore-scripts
